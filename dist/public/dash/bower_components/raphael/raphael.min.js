...
!function t(e, r) {
  "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) && "object" == (typeof module === "undefined" ? "undefined" : (0, _typeof2["default"])(module)) ? module.exports = r() : "function" == typeof define && define.amd ? define([], r) : "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) ? exports.Raphael = r() : e.Raphael = r();
}(void 0, function () {
  return function (t) {
    function e(i) {
    ...
    i = [r(2)], n = function (t) {
      ...
      if (e._g = T, e.type = T.win.SVGAngle || T.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML", "VML" == e.type) {
        var Nt = T.doc.createElement("div"),
          Lt;
        if (Nt.innerHTML = '<v:shape adj="1"/>', Lt = Nt.firstChild, Lt.style.behavior = "url(#default#VML)", !Lt || "object" != (0, _typeof2["default"])(Lt.adj)) return e.type = R;
        Nt = null;
      }
      e.svg = !(e.vml = "VML" == e.type), e._Paper = M, e.fn = N = M.prototype = e.prototype, e._id = 0, e.is = function (t, e) {
        return e = O.call(e), "finite" == e ? !at[A](+t) : "array" == e ? t instanceof Array : "null" == e && null === t || e == (0, _typeof2["default"])(t) && null !== t || "object" == e && t === Object(t) || "array" == e && Array.isArray && Array.isArray(t) || tt.call(t).slice(8, -1).toLowerCase() == e;
    ...
    !function (r) {
      ...
      eve = function (_eve) {
        ...
        for (b = 0; b < _; b++) if (l = a[b], "zIndex" in l) {
          if (l.zIndex == h[s]) {
