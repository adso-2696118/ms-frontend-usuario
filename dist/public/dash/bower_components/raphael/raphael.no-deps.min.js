  ...
  return function (t) {
    ...
    i = [r(2)], n = function (t) {
      ...
      function p(t, r, i) {
        ...
        for (x = 0; x < h; x++) for (var y = 0; y < c; y++) {
          var m = f[x],
            b = f[x + 1],
            _ = p[y],
            w = p[y + 1],
      ...
      function b(r, i, n, a, s, o) {
        ...
        var l,
          ...
          m = {},
          b = {};
        if (a) for (w = 0, B = Me.length; w < B; w++) {
          var _ = Me[w];
          ...
          if (h) h.initstatus = a, h.start = new Date() - h.ms * a;else {
            for (var C in l) if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C))) switch (v[C] = i.attr(C), null == v[C] && (v[C] = ft[C]), m[C] = l[C], pt[C]) {
              ...
              case "transform":
                var L = i._,
                  F = le(L[C], m[C]);
                if (F) for (v[C] = F.from, m[C] = F.to, b[C] = [], b[C].real = !0, w = 0, B = v[C].length; w < B; w++) for (b[C][w] = [v[C][w][0]], N = 1, E = v[C][w].length; N < E; N++) b[C][w][N] = (m[C][w][N] - v[C][w][N]) / x;else {
      ...
      if (e._g = A, e.type = A.win.SVGAngle || A.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML", "VML" == e.type) {
        var Et = A.doc.createElement("div"),
          Lt;
        if (Et.innerHTML = '<v:shape adj="1"/>', Lt = Et.firstChild, Lt.style.behavior = "url(#default#VML)", !Lt || "object" != (0, _typeof2["default"])(Lt.adj)) return e.type = R;
        Et = null;
      }
      e.svg = !(e.vml = "VML" == e.type), e._Paper = N, e.fn = E = N.prototype = e.prototype, e._id = 0, e.is = function (t, e) {
        return e = O.call(e), "finite" == e ? !at[T](+t) : "array" == e ? t instanceof Array : "null" == e && null === t || e == (0, _typeof2["default"])(t) && null !== t || "object" == e && t === Object(t) || "array" == e && Array.isArray && Array.isArray(t) || tt.call(t).slice(8, -1).toLowerCase() == e;
      ...
      var _Pt = function Pt(t) {
          if (e.vml) {
            ...
            l.title = "Raphaël Colour Picker", l.style.display = "none", A.doc.body.appendChild(l), _Pt = n(function (t) {
      ...
      e.getRGB = n(function (t) {
        ...
        !(xt[T](t.toLowerCase().substring(0, 2)) || "#" == t.charAt()) && (t = _Pt(t));
        var r,
          i,
          n,
          s,
          ...
          for (var r = +new Date(), i = 0; i < Me.length; i++) {
            ...
            if (!n.el.removed && !n.paused) {
              var a = r - n.start,
                ...
                g = {},
                x;
              if (n.initstatus ? (a = (n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev) * s, n.status = n.initstatus, delete n.initstatus, n.stop && Me.splice(i--, 1)) : n.status = (n.prev + (n.percent - n.prev) * (a / s)) / n.anim.top, !(a < 0)) if (a < s) {
                var v = o(a / s);
                for (var y in l) if (l[T](y)) {
                  switch (pt[y]) {
                    ...
                    case "path":
                      ...
                      break;
                    case "transform":
                      if (h[y].real) for (d = [], m = 0, _ = l[y].length; m < _; m++) for (d[m] = [l[y][m][0]], w = 1, k = l[y][m].length; w < k; w++) d[m][w] = l[y][m][w] + v * s * h[y][m][w];else {
                        var B = function B(t) {
      ...
      ye.animateWith = function (t, r, i, n, a, s) {
        ...
        for (var c = 0, f = Me.length; c < f; c++) if (Me[c].anim == r && Me[c].el == t) {
        ...
        for (n = Me.length; i < n; i++) if (a = Me[i], a.el.id == this.id && (!t || a.anim == t)) {
        ...
        for (var r = 0; r < Me.length; r++) if (Me[r].el.id == this.id && (!e || Me[r].anim == e)) {
          var i = Me[r];
      ...
      var Fe = function Fe(t) {
          if (this.items = [], this.length = 0, this.type = "set", t) for (var e = 0, r = t.length; e < r; e++) !t[e] || t[e].constructor != ye.constructor && t[e].constructor != Fe || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++);
        },
        Pe = Fe.prototype;
      Pe.push = function () {
      ...
      return Pe.attr = function (t, r) {
        ...
        if (e.is(t, "array")) for (var r = this.set(), i = 0, n = t.length, a; i < n; i++) a = t[i] || {}, B[T](a.type) && r.push(this[a.type]().attr(a));
        return r;
        ...
        if (M.was) A.win.Raphael = M.is;else {
        ...
        var x = function x(i, n) {
          ...
          S = function S(i, a) {
            if ("text" == i.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
              ...
              } else for (u = o.getElementsByTagName("tspan"), p = 0, d = u.length; p < d; p++) p ? x(u[p], {
                dy: l * C,
                x: s.x
              }) : x(u[0], {
                dy: 0
    ...
    i = [r(1)], n = function (t) {
      if (!t || t.vml) {
        ...
        t._engine.initWin = function (t) {
          ...
          try {
            !e.namespaces.rvml && e.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"), E = function E(t) {
