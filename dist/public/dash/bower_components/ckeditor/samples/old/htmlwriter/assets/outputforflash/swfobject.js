var swfobject = function () {
  ...
  function E() {
    ...
    if (0 < a) for (var b = 0; b < a; b++) {
      ...
      if (0 < e.pv[0]) {
        var d = p(c);
        if (d) if (!A(r[b].swfVersion) || e.wk && 312 > e.wk) {
          if (r[b].expressInstall && F()) {
            ...
            for (var h = {}, d = d.getElementsByTagName("param"), k = d.length, l = 0; l < k; l++) "movie" != d[l].getAttribute("name").toLowerCase() && (h[d[l].getAttribute("name")] = d[l].getAttribute("value"));
            G(g, h, c, f);
          } else W(d), f && f(g);
  ...
  function J(a) {
    var b = d.createElement("div");
    if (e.win && e.ie) b.innerHTML = a.innerHTML;else if (a = a.getElementsByTagName("object")[0]) if (a = a.childNodes) for (var c = a.length, f = 0; f < c; f++) 1 == a[f].nodeType && "PARAM" == a[f].nodeName || 8 == a[f].nodeType || b.appendChild(a[f].cloneNode(!0));
    return b;
  }
  function K(a, b, c) {
    var f,
