(function (q) {
  ...
  function Kb(a) {
    ...
    for (var b = a.text.length, c, d = a; c = Aa(d, !0);) c = c.find(0, !0), d = c.from.line, b += c.from.ch - c.to.ch;
  ...
  function Gc() {}
  function Cd(a) {
    a.display.scrollbars && (a.display.scrollbars.clear(), a.display.scrollbars.addClass && kb(a.display.wrapper, a.display.scrollbars.addClass));
  ...
  function Lc(a, b) {
    ...
    e = a.display;
    0 == e.view.length || f >= e.viewTo || g <= e.viewFrom ? (e.view = Nb(a, f, g), e.viewFrom = f) : (e.viewFrom > f ? e.view = Nb(a, f, e.viewFrom).concat(e.view) : e.viewFrom < f && (e.view = e.view.slice(Ca(a, f))), e.viewFrom = f, e.viewTo < g ? e.view = e.view.concat(Nb(a, e.viewTo, g)) : e.viewTo > g && (e.view = e.view.slice(0, Ca(a, g))));
    e.viewTo = g;
  ...
  function Md(a, b) {
    for (var c = b.viewport, d = !0;; d = !1) {
      if (!d || !a.options.lineWrapping || b.oldDisplayWidth == pa(a)) if (c && null != c.top && (c = {
    ...
    b.signal(a, "update", a);
    if (a.display.viewFrom != a.display.reportedViewFrom || a.display.viewTo != a.display.reportedViewTo) b.signal(a, "viewportChange", a, a.display.viewFrom, a.display.viewTo), a.display.reportedViewFrom = a.display.viewFrom, a.display.reportedViewTo = a.display.viewTo;
  }
  function Pc(a, b) {
    var c = new Mb(a, b);
    if (Lc(a, c)) {
  ...
  function Ob(a) {
    a.node == a.text && (a.node = t("div", null, null, "position: relative"), a.text.parentNode && a.text.parentNode.replaceChild(a.node, a.text), a.node.appendChild(a.text), B && 8 > C && (a.node.style.zIndex = 2));
    return a.node;
  }
  function Pd(a, b) {
  ...
  function Qd(a, b, c, d) {
    ...
    if (a.options.lineNumbers || e) {
      var f = Ob(b),
        g = b.gutter = t("div", null, "CodeMirror-gutter-wrapper", "left: " + (a.options.fixedGutter ? d.fixedPos : -d.gutterTotalWidth) + "px; width: " + d.gutterTotalWidth + "px");
      ...
      if (e) for (b = 0; b < a.options.gutters.length; ++b) c = a.options.gutters[b], (f = e.hasOwnProperty(c) && e[c]) && g.appendChild(t("div", [f], "CodeMirror-gutter-elt", "left: " + d.gutterLeft[c] + "px; width: " + d.gutterWidth[c] + "px"));
    }
  }
  function vf(a, b, c, d) {
    var e = Pd(a, b);
  ...
  function Sc(a, b, c, d, e) {
    ...
    for (var k = d.ranges.length - 1; 0 <= k; k--) {
      ...
      Oa(a.doc, m);
      L(a, "inputRead", a, m);
      if (b && !a.state.pasteIncoming && a.options.electricChars && a.options.smartIndent && 100 > l.head.ch && (!k || d.ranges[k - 1].head.line != l.head.line)) {
  ...
  function wf(a, b, c) {
    function d(b, c, d) {
      for (var e = -1; e < (l ? l.length : 0); e++) for (var f = 0 > e ? k.map : l[e], g = 0; g < f.length; g += 3) {
        var h = f[g + 2];
        if (h == b || h == c) {
  ...
  function he(a, b) {
    for (var c = a.doc, d = {}, e = d.cursors = document.createDocumentFragment(), f = d.selection = document.createDocumentFragment(), g = 0; g < c.sel.ranges.length; g++) if (!1 !== b || g != c.sel.primIndex) {
      ...
      if (k || a.options.showCursorWhenSelecting) {
        ...
        p.other && (l = m.appendChild(t("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor")), l.style.display = "", l.style.left = p.other.left + "px", l.style.top = p.other.top + "px", l.style.height = .85 * (p.other.bottom - p.other.top) + "px");
      }
      k || zf(a, h, f);
    }
    return d;
    ...
    function e(b, c, e) {
      ...
      Af(Y(f), c || 0, null == e ? h : e, function (g, q, t) {
        var u = Yb(a, r(b, g), "div", f, "left"),
          v,
          w;
        g == q ? (v = u, t = w = u.left) : (v = Yb(a, r(b, q - 1), "div", f, "right"), "rtl" == t && (t = u, u = v, v = t), t = u.left, w = v.right);
        null == c && 0 == g && (t = l);
  ...
  function fd(a, b, c) {
    ...
    0 > b && (b = 0);
    for (d = u(d, e);;) if (e = Ef(a, d, e, b, c), f = (d = Aa(d, !1)) && d.find(0, !0), d && (e.ch > f.from.ch || e.ch == f.from.ch && 0 < e.xRel)) e = F(d = f.to.line);else return e;
  }
    ...
    if (a = a.curOp.ownsGroup) try {
      ...
      for (b = 0; b < a.length; b++) {
        var e = a[b],
          c = e.cm,
          f = d = c.display;
        !f.scrollbarsClipped && f.scroller.offsetWidth && (f.nativeBarWidth = f.scroller.offsetWidth - f.scroller.clientWidth, f.heightForcer.style.height = da(c) + "px", f.sizer.style.marginBottom = -f.nativeBarWidth + "px", f.sizer.style.borderRightWidth = da(c) + "px", f.scrollbarsClipped = !0);
  ...
  function Q(a, b, c, d) {
    ...
    if (b >= e.viewTo) ra && Mc(a.doc, b) < e.viewTo && qa(a);else if (c <= e.viewFrom) ra && Ld(a.doc, c + d) > e.viewFrom ? qa(a) : (e.viewFrom += d, e.viewTo += d);else if (b <= e.viewFrom && c >= e.viewTo) qa(a);else if (b <= e.viewFrom) {
      ...
      var f = dc(a, b, b, -1),
        g = dc(a, c, c + d, 1);
      f && g ? (e.view = e.view.slice(0, f.index).concat(Nb(a, f.lineN, g.lineN)).concat(e.view.slice(g.index)), e.viewTo += d) : qa(a);
    }
  ...
  function Nf(a, b, c, d, e) {
    ...
    if (b.altKey) d = "rect", e || (m = new z(c, c)), c = Ua(a, b, !0, !0), p = -1;else if ("double" == d) {
  ...
  function hd(a, b, c, d, e) {
    ...
    for (k = 0; k < a.options.gutters.length; ++k) {
      ...
      if (l && l.getBoundingClientRect().right >= f) return f = Ba(a.doc, g), e(a, c, a, f, a.options.gutters[k], b), ld(b);
    }
  }
  function Hf(a) {
    var b = this;
  ...
  function lb(a, b) {
    2 > Math.abs(a.doc.scrollTop - b) || (a.doc.scrollTop = b, wa || Pc(a, {
      top: b
    }), a.display.scroller.scrollTop != b && (a.display.scroller.scrollTop = b), a.display.scrollbars.setScrollTop(b), wa && Pc(a), fb(a, 100));
  }
  function Ma(a, b, c) {
  ...
  function Wa(a, b, c, d, e) {
    ...
    if (f.collapsed) {
      if (Qe(a, b.line, b, c, f) || b.line != c.line && Qe(a, c.line, b, c, f)) throw Error("Inserting collapsed marker partially overlapping an existing one");
      ra = !0;
    }
    f.addToHistory && Ie(a, {
      from: b,
  ...
  function od(a, b) {
    ...
    if (c) for (f = 0; f < c.length; ++f) if (h = c[f], null == h.to) (k = zb(d, h.marker), k) ? g && (h.to = null == k.to ? null : k.to + n) : h.to = e;
  ...
  function Aa(a, b) {
    var c = ra && a.markedSpans,
      d;
    if (c) for (var e, f = 0; f < c.length; ++f) e = c[f], e.marker.collapsed && null == (b ? e.from : e.to) && (!d || 0 > Ve(d, e.marker)) && (d = e.marker);
    return d;
  }
  function Qe(a, b, c, d, e) {
    ...
    if (a = ra && a.markedSpans) for (b = 0; b < a.length; ++b) {
      ...
      if (f.marker.collapsed) {
        ...
        if (!(0 <= h && 0 >= k || 0 >= h && 0 <= k) && (0 >= h && (0 < y(g.to, c) || f.marker.inclusiveRight && e.inclusiveLeft) || 0 <= h && (0 > y(g.from, d) || f.marker.inclusiveLeft && e.inclusiveRight))) return !0;
      }
    }
  }
  function ia(a) {
  ...
  function $f(a, b, c, d) {
    ...
    nc(a, b, "widget", function (b) {
      ...
      e.line = b;
      f && !ya(a, b) && (c = ea(b) < a.scrollTop, ca(b, b.height + ub(e)), c && lc(f, null, e.height), f.curOp.forceUpdate = !0);
      return !0;
    });
    return e;
  }
  ...
  function Ie(a, b, c, d) {
    ...
    var f = +new Date(),
      g,
      h;
    if (h = e.lastOp == d || e.lastOrigin == b.origin && b.origin && ("+" == b.origin.charAt(0) && a.cm && e.lastModTime > f - a.cm.options.historyEventDelay || "*" == b.origin.charAt(0))) e.lastOp == d ? (ce(e.done), g = A(e.done)) : e.done.length && !A(e.done).ranges ? g = A(e.done) : 1 < e.done.length && !e.done[e.done.length - 2].ranges ? (e.done.pop(), g = A(e.done)) : g = void 0, h = g;
    if (h) {
      var k = A(g.changes);
  ...
  Uc.prototype = V({
    ...
    pollContent: function () {
      ...
      h = A(b);
      k = A(e);
      for (l = Math.min(h.length - (1 == b.length ? g : 0), k.length - (1 == e.length ? g : 0)); f < l && h.charCodeAt(h.length - f - 1) == k.charCodeAt(k.length - f - 1);) ++f;
  ...
  q.prototype = {
    ...
    heightAtLine: function (a, b) {
      var c = !1,
        d;
      "number" == typeof a ? (d = this.doc.first + this.doc.size - 1, a < this.doc.first ? a = this.doc.first : a > d && (a = d, c = !0), d = u(this.doc, a)) : d = a;
      return cd(this, d, {
        top: 0,
        left: 0
    ...
    clearGutter: M(function (a) {
      var b = this,
        ...
        d = c.first;
      c.iter(function (c) {
        c.gutterMarkers && c.gutterMarkers[a] && (c.gutterMarkers[a] = null, na(b, d, "gutter"), hf(c.gutterMarkers) && (c.gutterMarkers = null));
        ++d;
      });
    }),
    lineInfo: function (a) {
    ...
    scrollIntoView: M(function (a, b) {
      ...
      if (null != a.from.line) mc(this), this.curOp.scrollToPos = a;else {
        var c = cc(this, Math.min(a.from.left, a.to.left), Math.min(a.from.top, a.to.top) - a.margin, Math.max(a.from.right, a.to.right), Math.max(a.from.bottom, a.to.bottom) + a.margin);
  ...
  x("lineWrapping", !1, function (a) {
    a.options.lineWrapping ? (mb(a.display.wrapper, "CodeMirror-wrap"), a.display.sizer.style.minWidth = "", a.display.sizerWidth = null) : (kb(a.display.wrapper, "CodeMirror-wrap"), Dc(a));
    Ac(a);
    Q(a);
    hb(a);
    setTimeout(function () {
