(function () {
  ...
  e.prototype._createModifier = function (a) {
    ...
    this.codeContainer.on("change", function () {
      ...
      null !== a ? (k.actualConfig.toolbar = a.toolbar ? a.toolbar : k.actualConfig.toolbar, k._fillHintByUnusedElements(), k._refreshEditor(), k.mainContainer.removeClass("invalid")) : k.mainContainer.addClass("invalid");
    });
  ...
  e.prototype._setupActualConfig = function (a) {
    ...
    CKEDITOR.tools.isArray(a.toolbar) || (a.toolbarGroups || (a.toolbarGroups = this.fullToolbarEditor.getFullToolbarGroupsConfig(!0)), this._fixGroups(a), a.toolbar = this._mapToolbarGroupsToToolbar(a.toolbarGroups, this.actualConfig.removeButtons), this.actualConfig.toolbar = a.toolbar, this.actualConfig.removeButtons = "");
  };
  e.prototype._mapToolbarGroupsToToolbar = function (a, d) {
    ...
    for (var f = a.length; f--;) {
      ...
      "separator" === a[f].type ? a[f] = "/" : CKEDITOR.tools.isArray(c) && 0 === c.length ? a.splice(f, 1) : a[f] = "string" == typeof c ? c : {
        name: a[f].name,
        items: c
      };
    }
