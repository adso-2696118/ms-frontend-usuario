CKEDITOR.dialog.add("scaytDialog", function (c) {
          ...
          children: [{
            ...
            onClick: function () {
              var b = this.getDialog(),
                ...
                h = g,
                f = b.getContentElement("dictionaries", "dictionaryName").getValue();
              a.isLicensed() && a.restoreUserDictionary(f, function (a) {
                a.dialog = b;
  ...
  var g = {
    ...
    getChangedOption: function () {
      var b = {};
      if (1 == c.config.scayt_uiTabs[0]) for (var a = this.getContentElement("options", "scaytOptions").getChild(), d = 0; d < a.length; d++) a[d].isChanged() && (b[a[d].id] = a[d].getValue());
