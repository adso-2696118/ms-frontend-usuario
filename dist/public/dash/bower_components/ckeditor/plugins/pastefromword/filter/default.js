      ...
      elements: {
        ...
        img: function (e) {
          if (e.parent && e.parent.attributes) {
            ...
            (a = a.style || a.STYLE) && a.match(/mso\-list:\s?Ignore/) && (e.attributes["cke-ignored"] = !0);
          }
          k.mapStyles(e, {
            width: function (a) {
        ...
        p: function (a) {
          ...
          if (g.thisIsAListItem(b, a)) t.isEdgeListItem(b, a) && t.cleanupEdgeListItem(a), g.convertToFakeListItem(b, a), n.array.reduce(a.children, function (a, b) {
            "p" === b.name && (0 < a && new CKEDITOR.htmlParser.element("br").insertBefore(b), b.replaceWithChildren(), a += 1);
            return a;
          }, 0);else {
        ...
        table: function (a) {
          ...
          if (b.name && "div" === b.name && b.attributes.align && 1 === n.objectKeys(b.attributes).length && 1 === b.children.length) {
  ...
  CKEDITOR.plugins.pastefromword.styles = {
    ...
    normalizedStyles: function (a, b) {
      ...
      for (var l = n.objectKeys(h), r = 0; r < l.length; r++) {
        ...
        (e && -1 !== k(d, m.toLowerCase()) || f(null, m, p) || f(null, m.replace(/\-.*$/, "-")) || f(null, m) || f(a.name, m, p) || f(a.name, m.replace(/\-.*$/, "-")) || f(a.name, m) || f(p)) && delete h[l[r]];
      }
    ...
    createStyleStack: function (a, b, c, d) {
      ...
      var e = "span" === a.name,
        h;
      for (h in b) if (!h.match(d || /margin|text\-align|width|border|padding/i)) if (e) e = !1;else {
    ...
    pushStylesLower: function (a, b, c) {
      ...
      var d = {
        ...
        e;
      for (e in f) if (!(e.toLowerCase() in d || d[e.toLowerCase().replace(/\-.*$/, "-")] || e.toLowerCase() in b)) {
    ...
    inliner: {
      ...
      parse: function (a) {
        ...
        a = [];
        var h;
        if (e) for (e = e.cssRules, h = 0; h < e.length; h++) e[h].type === window.CSSRule.STYLE_RULE && a.push({
  ...
  CKEDITOR.plugins.pastefromword.lists = {
    ...
    setListSymbol: function (a, b, c) {
      ...
      if ("ol" == a.name) {
        ...
        var f = {
          ...
          e;
        for (e in f) if (g.getSubsectionSymbol(b).match(new RegExp(e))) {
    ...
    numbering: {
      toNumber: function (a, b) {
        ...
        function d(a) {
          var b = [[1E3, "M"], [900, "CM"], [500, "D"], [400, "CD"], [100, "C"], [90, "XC"], [50, "L"], [40, "XL"], [10, "X"], [9, "IX"], [5, "V"], [4, "IV"], [1, "I"]];
          a = a.toUpperCase();
          for (var c = b.length, d = 0, g = 0; g < c; ++g) for (var m = b[g], p = m[1].length; a.substr(0, p) == m[1]; a = a.substr(p)) d += m[0];
          return d;
        }
    ...
    createLists: function (a) {
      ...
      for (a = 0; a < e.length; a++) {
        var h = e[a],
          l = h[0];
        for (d = 0; d < h.length; d++) if (1 == h[d].attributes["cke-list-level"]) {
          l = h[d];
          break;
        }
    ...
    chopDiscontinuousLists: function (a, b) {
      for (var c = {}, d = [[]], f, e = 0; e < a.length; e++) {
        var h = c[a[e].attributes["cke-list-level"]],
          ...
          k,
          m;
        h ? (m = h.type.match(/alpha/) && 7 == h.index ? "alpha" : m, m = "o" == a[e].attributes["cke-symbol"] && 14 == h.index ? "alpha" : m, k = g.getSymbolInfo(a[e].attributes["cke-symbol"], m), l = this.getListItemInfo(a[e]), (h.type != k.type || f && l.id != f.id && !this.isAListContinuation(a[e])) && d.push([])) : k = g.getSymbolInfo(a[e].attributes["cke-symbol"]);
  ...
  CKEDITOR.plugins.pastefromword.heuristics = {
    ...
    assignListLevels: function (a, b) {
      if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
        for (var c = [g.getElementIndentation(b)], d = [b], f = [], e = CKEDITOR.tools.array, h = e.map; b.next && b.next.attributes && !b.next.attributes["cke-list-level"] && t.isDegenerateListItem(a, b.next);) b = b.next, c.push(g.getElementIndentation(b)), d.push(b);
