...
CKEDITOR.dialog.add("uicolor", function (f) {
  ...
  function C(a) {
    ...
    var c = !/mouse/.test(a.name),
      b = a.data.getTarget(),
      h;
    "td" == b.getName() && (h = b.getChild(0).getHtml()) && (u(a), c ? e = b : D = b, c && b.addClass(G(h) ? "cke_colordialog_focused_light" : "cke_colordialog_focused_dark"), v(h));
  }
  function u(a) {
    if (a = !/mouse/.test(a.name) && e) a.removeClass("cke_colordialog_focused_light"), a.removeClass("cke_colordialog_focused_dark");
    e || D || v(!1);
  }
  function v(a) {
    a ? (l.getById(w).setStyle("background-color", a), l.getById(x).setHtml(a)) : (l.getById(w).removeStyle("background-color"), l.getById(x).setHtml("\x26nbsp;"));
  }
  function G(a) {
    a = a.replace(/^#/, "");
  ...
  function F(a, c) {
    ...
    if (a && k.getContentElement("picker", "predefined").getValue() !== b) k.getContentElement("picker", "predefined").setValue(b);else if (c) {
      var d = E(b);
      d ? r(d) : n();
  ...
  return {
    ...
    onHide: function () {
      n();
      m(null);
      e && (e.removeClass("cke_colordialog_focused_light"), e.removeClass("cke_colordialog_focused_dark"), e = null, v(null));
    },
    contents: [{
      id: "picker",
      label: d.title,
      ...
      elements: [{
        ...
        children: [{
          ...
          children: [{
            type: "html",
            html: "\x3cspan\x3e" + d.highlight + '\x3c/span\x3e\x3cdiv id\x3d"' + w + '" style\x3d"border: 1px solid; height: 74px; width: 74px;"\x3e\x3c/div\x3e\x3cdiv id\x3d"' + x + '"\x3e\x26nbsp;\x3c/div\x3e\x3cspan\x3e' + d.selected + '\x3c/span\x3e\x3cdiv id\x3d"' + t + '" style\x3d"border: 1px solid; height: 20px; width: 74px;"\x3e\x3c/div\x3e'
          }, {
            type: "text",
            label: d.selected,
        ...
        children: [{
          ...
          onChange: function () {
            var a = this.getValue();
            a && CKEDITOR.tools.style.parse._findColor(a).length && this.setValue('config.uiColor \x3d "' + a.toLowerCase() + '"', !0);
          }
        }]
      }]
    }]
