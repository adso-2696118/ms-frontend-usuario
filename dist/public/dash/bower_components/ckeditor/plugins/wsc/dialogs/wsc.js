...
(function () {
  ...
  var J = function (b) {
      var c, d, e;
      for (e in b) {
        if (c = a.dialog.getContentElement(a.dialog._.currentTabId, e)) c = c.getElement();else if (b[e].instance) c = b[e].instance.getElement().getFirst() || b[e].instance.getElement();else continue;
  ...
  a.sendData = function (b) {
    ...
    var h = function (h) {
      c = b._.currentTabId;
      h = h || window.event;
      h.data.getTarget().is("a") && c !== a.previousTab && (a.previousTab = c, d = b._.contents[c].Content, e = a.iframeNumber + "_" + c, a.div_overlay.setEnable(), d.getElement().getChildCount() ? E(a.targetFromFrame[e], a.cmd[c]) : (a.setIframe(d, c), f = document.getElementById(e), a.targetFromFrame[e] = f.contentWindow));
    };
  ...
  a.buildOptionLang = function (b, c) {
    ...
    if (0 === d.options.length) {
      ...
      k.sort();
      for (var p = 0; p < k.length; p++) f = document.createElement("option"), f.setAttribute("value", k[p][1]), h = document.createTextNode(k[p][0]), f.appendChild(h), e.appendChild(f);
      d.appendChild(e);
    }
  ...
  var B = function (a) {
    ...
    w = function (b) {
      ...
      b.onchange = function (b) {
        ...
        for (var k in a.cmd) if (a.cmd[k] == d) {
          a.previousTab = k;
          break;
        }
        g.postMessage.send({
    ...
    N = function () {
      ...
      setTimeout(function () {
        ...
        if (g.misc.hasClass(c, "cke_dialog_tab") || g.misc.hasClass(c, "cke_dialog_contents_body") || !g.misc.isVisible(c)) for (var e = 0, f; e < d.count(); e++) {
  ...
  CKEDITOR.dialog.add("checkspell", function (b) {
    function c(a) {
      ...
      a._.moved || (r = isNaN(c) && isNaN(e) ? 0 : 1, isNaN(c) && (c = (m.width - n.width) / 2), 0 > c && (c = 0), c > m.width - n.width && (c = m.width - n.width), isNaN(e) && (e = (m.height - n.height) / 2), 0 > e && (e = 0), e > m.height - n.height && (e = m.height - n.height), a.move(c, e, r));
    }
    function d() {
      b.wsc = {};
      (function (a) {
  ...
  CKEDITOR.dialog.add("options", function (b) {
    ...
    return {
      ...
      onShow: function () {
        ...
        parseInt(e.IgnoreMixedCaseWords, 10) ? d.IgnoreMixedCaseWords.setValue("checked", !1) : d.IgnoreMixedCaseWords.setValue("", !1);
