...
(function () {
  ...
  var l = {
    ...
    A = CKEDITOR.tools.extend({
      table: 1
    }, n.$block, n.$listItem, n.$tableContent, n.$list),
    C = /\s*(?:;\s*|$)/,
    q = {
      smiley: ":)",
      sad: ":(",
        ...
        elements: {
          $: function (b) {
            var c = b.attributes,
              ...
              e,
              d = b.name;
            if (d in x) d = x[d];else if ("span" == d) {
              if (e = g.color) d = "color", e = CKEDITOR.tools.convertRgbToHex(e);else {
              ...
              if (e = c.href) -1 !== e.indexOf("mailto:") ? (d = "email", b.children = [new CKEDITOR.htmlParser.text(e.replace("mailto:", ""))], e = "") : ((d = 1 == b.children.length && b.children[0]) && d.type == CKEDITOR.NODE_TEXT && d.value == e && (e = ""), d = "url");
            } else if ("img" == d) {
              b.isEmpty = 0;
