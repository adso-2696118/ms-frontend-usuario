...
(function () {
  function k(a, c, b, f) {
    a = a.lang.devtools;
    var l = '\x3ca href\x3d"http://docs.ckeditor.com/#!/api/CKEDITOR.dialog.definition.' + (b ? "text" == b.type ? "textInput" : b.type : "content") + '" target\x3d"_blank" rel\x3d"noopener noreferrer"\x3e' + (b ? b.type : "content") + "\x3c/a\x3e";
  ...
  CKEDITOR.on("dialogDefinition", function (d) {
    ...
    if (c._.showDialogDefinitionTooltips) {
      a || (a = CKEDITOR.dom.element.createFromHtml('\x3cdiv id\x3d"cke_tooltip" tabindex\x3d"-1" style\x3d"position: absolute"\x3e\x3c/div\x3e', CKEDITOR.document), a.hide(), a.on("mouseover", function () {
        this.show();
      ...
      b.on("load", function () {
        for (var d = b.parts.tabs.getChildren(), g, e = 0, h = d.count(); e < h; e++) g = d.getItem(e), g.on("mouseover", function () {
          var a = this.$.id;
