...
(function () {
    ...
    beforeInit: function (a) {
      ...
      a.on("fileUploadResponse", function (a) {
        ...
        try {
          ...
          if (e.uploaded) for (var g in e) f[g] = e[g];else a.cancel();
        } catch (h) {
  ...
  k.prototype = {
    ...
    attachRequestListeners: function () {
      ...
      c.onload = function () {
        b.update();
        if ("abort" != b.status) if (b.uploaded = b.uploadTotal, 200 > c.status || 299 < c.status) b.message = b.lang.filetools["httpError" + c.status], b.message || (b.message = b.lang.filetools.httpError.replace("%1", c.status)), b.changeStatus("error");else {
          for (var a = {
              fileLoader: b
