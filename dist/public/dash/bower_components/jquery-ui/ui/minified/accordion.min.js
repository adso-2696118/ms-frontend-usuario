...
(function (t) {
  ...
  return t.widget("ui.accordion", {
    ...
    _animate: function (t, e, i) {
      ...
      return "number" == typeof p && (o = p), "string" == typeof p && (n = p), n = n || p.easing || c.easing, o = o || p.duration || c.duration, e.length ? t.length ? (s = t.show().outerHeight(), e.animate(this.hideProps, {
        duration: o,
        easing: n,
        step: function (t, e) {
          e.now = Math.round(t);
