...
(function (window, undefined) {
  ...
  jQuery.extend({
    ...
    data: function data(elem, name, _data, pvt /* Internal Use Only */) {
      ...
      if ((0, _typeof2["default"])(name) === "object" || typeof name === "function") {
        if (pvt) {
  ...
  jQuery.event = {
    ...
    trigger: function trigger(event, data, elem, onlyHandlers) {
      ...
      event = (0, _typeof2["default"])(event) === "object" ?
      // jQuery.Event object
  ...
  (function (window, undefined) {
    var cachedruns,
      ...
      assertHrefNotNormalized = assert(function (div) {
        ...
        return div.firstChild && (0, _typeof2["default"])(div.firstChild.getAttribute) !== strundefined && div.firstChild.getAttribute("href") === "#";
      }),
      // Check if attributes should be retrieved by attribute nodes
      assertAttributes = assert(function (div) {
        div.innerHTML = "<select></select>";
        var type = (0, _typeof2["default"])(div.lastChild.getAttribute("multiple"));
    ...
    Expr = Sizzle.selectors = {
      ...
      find: {
        "ID": assertGetIdNotName ? function (id, context, xml) {
          if ((0, _typeof2["default"])(context.getElementById) !== strundefined && !xml) {
          ...
          if ((0, _typeof2["default"])(context.getElementById) !== strundefined && !xml) {
            var m = context.getElementById(id);
            return m ? m.id === id || (0, _typeof2["default"])(m.getAttributeNode) !== strundefined && m.getAttributeNode("id").value === id ? [m] : undefined : [];
          }
        },
        ...
        "NAME": assertUsableName && function (tag, context) {
          if ((0, _typeof2["default"])(context.getElementsByName) !== strundefined) {
            return context.getElementsByName(name);
          }
        },
        "CLASS": assertUsableClassName && function (className, context, xml) {
          if ((0, _typeof2["default"])(context.getElementsByClassName) !== strundefined && !xml) {
      ...
      filter: {
        ...
        "CLASS": function CLASS(className) {
          ...
          return function (elem) {
            return pattern.test(elem.className || (0, _typeof2["default"])(elem.getAttribute) !== strundefined && elem.getAttribute("class") || "");
          };
        },
