...
!function (a) {
  ...
  function h(f, g, i) {
    ...
    function w(b, c, e) {
      function f(c, e, g, j) {
        function l(g, j, q) {
          ...
          function s(b, c, e) {
            var f, g;
            if (o().validPositions[b - 1] && e && o().tests[b]) for (var h = o().validPositions[b - 1].locator, i = o().tests[b][0].locator, j = 0; j < e; j++) if (h[j] !== i[j]) return h.slice(e + 1);
      ...
      function g(a) {
        if (i.keepStatic && b > 0 && a.length > 1 + ("" === a[a.length - 1].match.def ? 1 : 0) && !0 !== a[0].match.optionality && !0 !== a[0].match.optionalQuantifier && null === a[0].match.fn && !/[0-9a-bA-Z]/.test(a[0].match.def)) {
          ...
          if (o().validPositions[b - 1].alternation === a[0].alternation) return [s(a)];
    ...
    function C(b, c, f, g, h, j) {
      ...
      function l(c, e, f) {
        var h = !1;
        return a.each(w(c), function (j, l) {
          for (var n = l.match, s = e ? 1 : 0, t = "", u = n.cardinality; u > s; u--) t += G(c - (u - 1));
          if (e && (t += e), y(!0), !1 !== (h = null != n.fn ? n.fn.test(t, o(), c, f, i, k(b)) : (e === n.def || e === i.skipOptionalPartCharacter) && "" !== n.def && {
            c: I(c, n, !0) || n.def,
            pos: c
          })) {
            var v = h.c !== d ? h.c : e;
            ...
            return (!0 === h || h.pos !== d || h.c !== d) && (j > 0 && p(!0), m(w, a.extend({}, l, {
              input: A(v, n, w)
            }), g, k(b)) || (h = !1), !1);
          }
        }), h;
      ...
      function m(b, c, e, f) {
        if (f || i.insertMode && o().validPositions[b] !== d && e === d) {
          ...
          for (g = k = b; g <= j; g++) {
            var t = h[g];
            if (t !== d) for (var u = k; u < o().maskLength && (null === t.match.fn && m[g] && (!0 === m[g].match.optionalQuantifier || !0 === m[g].match.optionality) || null != t.match.fn);) {
              if (u++, !1 === r && h[u] && h[u].match.def === t.match.def) o().validPositions[u] = a.extend(!0, {}, h[u]), o().validPositions[u].input = t.input, n(u), k = u, l = !0;else if (v(u, t.match.def)) {
      ...
      if (a.isFunction(i.preValidation) && !f && !0 !== g && !0 !== j && (x = i.preValidation(y(), u, c, k(b), i)), !0 === x) {
        if (n(u), k(b) && (P(d, e.keyCode.DELETE, b, !0, !0), u = o().p), u < o().maskLength && (U === d || u < U) && (x = l(u, c, f), (!f || !0 === g) && !1 === x && !0 !== j)) {
          var H = o().validPositions[u];
          if (!H || null !== H.match.fn || H.match.def !== c && c !== i.skipOptionalPartCharacter) {
            if ((i.insertMode || o().validPositions[E(u)] === d) && !D(u, !0)) for (var J = u + 1, K = E(u); J <= K; J++) if (!1 !== (x = l(J, c, f))) {
              !function (b, c) {
                ...
                if (e) for (var f = e.locator, g = f.length, h = b; h < c; h++) if (o().validPositions[h] === d && !D(h, !0)) {
                  ...
                  }), j.generatedInput = !0, m(h, j, !0), o().validPositions[c] = d, l(c, e.input, !0);
                }
              }(u, x.pos !== d ? x.pos : J), u = J;
              break;
            }
          } else x = {
            caret: E(u)
        ...
        !1 === x && i.keepStatic && !f && !0 !== h && (x = function (b, c, e) {
          var f,
            h,
            j,
            k,
      ...
      if (a.isFunction(i.postValidation) && !1 !== x && !f && !0 !== g && !0 !== j) {
      ...
      return x && x.pos === d && (x.pos = u), !1 !== x && !0 !== j || (p(!0), o().validPositions = a.extend(!0, {}, F)), x;
    }
    function D(a, b) {
      var c = t(a).match;
    ...
    function E(a, b) {
      ...
      if (a >= c) return c;
      var d = a;
      for (w(c + 1).length > 1 && (n(!0, c + 1, !0), c = o().maskLength); ++d < c && (!0 === b && (!0 !== u(d).match.newBlockMarker || !D(d)) || !0 !== b && !D(d)););
      return d;
    }
    function F(a, b) {
      var c,
    ...
    function H(b, c, e, f, g) {
      ...
      b !== d && (b.inputmask._valueSet(c.join("")), e === d || f !== d && "blur" === f.type ? R(b, e, 0 === c.length) : m && f && "input" === f.type ? setTimeout(function () {
        L(b, e);
    ...
    function J(b, f, g, h, j) {
      ...
      var l = h.slice(),
        ...
        n = -1,
        r = d;
      if (p(), g || !0 === i.autoUnmask) n = E(n);else {
        var s = x().slice(0, E(-1)).join(""),
          v = l.join("").match(new RegExp("^" + e.escapeRegex(s), "g"));
        v && v.length > 0 && (l.splice(0, v.length * s.length), n = E(n));
      }
      if (-1 === n ? (o().p = E(n), n = 0) : o().p = n, a.each(l, function (c, e) {
        if (e !== d) if (o().validPositions[c] === d && l[c] === I(c) && D(c, !0) && !1 === C(c, l[c], !0, d, d, !0)) o().p++;else {
          ...
          if (!k(n, m) || g || i.autoUnmask) {
            var u = g ? c : null == s.match.fn && s.match.optionality && h + 1 < o().p ? h + 1 : o().p;
            r = ca.keypressEvent.call(b, f, !0, !1, g, u), n = u + 1, m = "";
          } else r = ca.keypressEvent.call(b, f, !0, !1, !0, h + 1);
          if (!1 !== r && !g && a.isFunction(i.onBeforeWrite)) {
            var v = r;
            if (r = i.onBeforeWrite.call(W, f, y(), r.forwardPosition, i), (r = a.extend(v, r)) && r.refreshFromBuffer) {
              var w = r.refreshFromBuffer;
              z(!0 === w ? w : w.start, w.end, r.buffer), p(!0), r.caret && (o().p = r.caret, r.forwardPosition = r.caret);
            }
          }
        }
      }), f) {
    ...
    function M(b) {
      ...
      for (c = g - 1; c > h && (e = i[c], (e.match.optionality || e.match.optionalQuantifier && e.match.newBlockMarker || l && (l !== i[c].locator[j.alternation] && null != e.match.fn || null === e.match.fn && e.locator[j.alternation] && B(e.locator[j.alternation].toString().split(","), l.toString().split(",")) && "" !== w(c)[0].def)) && f[c] === I(c, e.match)); c--) g--;
      return b ? {
        l: g,
        def: i[g] ? i[g].match : d
      } : g;
    ...
    function N(a) {
      for (var b, c = M(), e = a.length, f = o().validPositions[q()]; c < e && !D(c, !0) && (b = f !== d ? t(c, f.locator.slice(""), f) : u(c)) && !0 !== b.match.optionality && (!0 !== b.match.optionalQuantifier && !0 !== b.match.newBlockMarker || c + 1 === e && "" === (f !== d ? t(c + 1, f.locator.slice(""), f) : u(c + 1)).match.def);) c++;
      for (; (b = o().validPositions[c - 1]) && b && b.match.optionality && b.input === i.skipOptionalPartCharacter;) c--;
      return a.splice(c), a;
    }
    function O(b) {
    ...
    function P(b, c, f, g, h) {
      ...
      var k = q(f.begin, !0);
      if (k < f.begin) o().p = E(k);else if (!0 !== g && (o().p = f.begin, !0 !== h)) for (; o().p < k && o().validPositions[o().p] === d;) o().p++;
    }
    function Q(d) {
      function e(a) {
        var b,
      ...
      g.style.width = f.width, g.style.textAlign = f.textAlign, V = c.createElement("div"), V.className = "im-colormask", d.parentNode.insertBefore(V, d), d.parentNode.removeChild(d), V.appendChild(g), V.appendChild(d), d.style.left = g.offsetLeft + "px", a(d).on("click", function (a) {
    ...
    function R(a, b, e) {
      function f() {
        m || null !== h.fn && j.input !== d ? m && (null !== h.fn && j.input !== d || "" === h.def) && (m = !1, l += "</span>") : (m = !0, l += "<span class='im-static'>");
      }
      function g(d) {
      ...
      if (V !== d) {
        var p = y();
        if (b === d ? b = L(a) : b.begin === d && (b = {
          begin: b,
          end: b
        }), !0 !== e) {
          var r = q();
          do {
            g(), o().validPositions[n] ? (j = o().validPositions[n], h = j.match, k = j.locator.slice(), f(), l += p[n]) : (j = t(n, k, n - 1), h = j.match, k = j.locator.slice(), (!1 === i.jitMasking || n < r || "number" == typeof i.jitMasking && isFinite(i.jitMasking) && i.jitMasking > n) && (f(), l += I(n, h))), n++;
          } while ((U === d || n < U) && (null !== h.fn || "" !== h.def) || r > n || m);
      ...
      ca = {
        ...
        keypressEvent: function keypressEvent(b, c, f, g, h) {
          ...
          if (l) {
            ...
            o().writeOutBuffer = !0;
            var r = C(n, q, g);
            if (!1 !== r && (p(!0), m = r.caret !== d ? r.caret : c ? r.pos + 1 : E(r.pos), o().p = m), !1 !== f && (setTimeout(function () {
              i.onKeyValidation.call(j, l, r, i);
            }, 0), o().writeOutBuffer && !1 !== r)) {
              var s = y();
              H(j, s, i.numericInput && r.caret === d ? F(m) : m, b, !0 !== c), !0 !== c && setTimeout(function () {
        ...
        pasteEvent: function pasteEvent(c) {
          ...
          if (a.isFunction(i.onBeforePaste)) {
            if (!1 === (m = i.onBeforePaste.call(W, h, i))) return c.preventDefault();
            m || (m = h);
          }
        ...
        inputFallBackEvent: function inputFallBackEvent(b) {
          ...
          if (y().join("") !== d) {
            var f = L(c);
            if (!1 === function (b, c, d) {
              if ("." === c.charAt(d.begin - 1) && "" !== i.radixPoint && (c = c.split(""), c[d.begin - 1] = i.radixPoint.charAt(0), c = c.join("")), c.charAt(d.begin - 1) === i.radixPoint && c.length > y().length) {
                var e = new a.Event("keypress");
                return e.which = i.radixPoint.charCodeAt(0), ca.keypressEvent.call(b, e, !0, !0, !1, d.begin - 1), !1;
              }
            }(c, d, f)) return !1;
            if (d = d.replace(new RegExp("(" + e.escapeRegex(x().join("")) + ")*"), ""), !1 === function (b, c, d) {
              if (k) {
                var e = c.replace(y().join(""), "");
                if (1 === e.length) {
                  var f = new a.Event("keypress");
                  return f.which = e.charCodeAt(0), ca.keypressEvent.call(b, f, !0, !0, !1, o().validPositions[d.begin - 1] ? d.begin : d.begin - 1), !1;
                }
              }
            }(c, d, f)) return !1;
            ...
            if (h !== l) {
              n.begin = 0;
              for (var r = (q = h.length >= l.length) ? h.length : l.length, s = 0; h.charAt(s) === l.charAt(s) && s < r; s++) n.begin++;
              q && (p += h.slice(n.begin, n.end));
            }
            j !== m && (j.length > m.length ? q && (n.end = n.begin) : j.length < m.length ? n.end += m.length - j.length : j.charAt(0) !== m.charAt(0) && n.end++), H(c, y(), n), p.length > 0 ? a.each(p.split(""), function (b, d) {
              var e = new a.Event("keypress");
              e.which = d.charCodeAt(0), _ = !1, ca.keypressEvent.call(c, e);
            }) : (n.begin === n.end - 1 && L(c, F(n.begin + 1), n.end), b.keyCode = e.keyCode.DELETE, ca.keydownEvent.call(c, b)), b.preventDefault();
          }
        },
        setValueEvent: function setValueEvent(b) {
          ...
          a.isFunction(i.onBeforeMask) && (d = i.onBeforeMask.call(W, d, i) || d), d = d.split(""), J(c, !0, !1, Y ? d.reverse() : d), S = y().join(""), (i.clearMaskOnLostFocus || i.clearIncomplete) && c.inputmask._valueGet() === x().join("") && c.inputmask._valueSet("");
        },
        focusEvent: function focusEvent(a) {
          var b = this,
            c = b.inputmask._valueGet();
          i.showMaskOnFocus && (!i.showMaskOnHover || i.showMaskOnHover && "" === c) && (b.inputmask._valueGet() !== y().join("") ? H(b, y(), E(q())) : !1 === aa && L(b, E(q()))), !0 === i.positionCaretOnTab && !1 === aa && "" !== c && (H(b, y(), L(b)), ca.clickEvent.apply(b, [a, !0])), S = y().join("");
        },
              ...
              if (e && (Y ? a.end = a.begin : a.begin = a.end), a.begin === a.end) switch (i.positionCaretOnClick) {
                ...
                default:
                  var h = a.begin,
                    j = q(h, !0),
                    k = E(j);
                  if (h < k) L(g, D(h, !0) || D(h - 1, !0) ? h : E(h));else {
                    var l = o().validPositions[j],
                      m = t(k, l ? l.match.locator : d, l),
                      n = I(k, m.match);
                    if ("" !== n && y()[k] !== n && !0 !== m.match.optionalQuantifier && !0 !== m.match.newBlockMarker || !D(k, !0) && m.match.def === n) {
                      var p = E(k);
                      (h >= p || h === k) && (k = p);
                    }
                    L(g, k);
        ...
        blurEvent: function blurEvent(b) {
          ...
          if (e.inputmask) {
            var f = e.inputmask._valueGet(),
              g = y().slice();
            "" !== f && (i.clearMaskOnLostFocus && (-1 === q() && f === x().join("") ? g = [] : N(g)), !1 === O(g) && (setTimeout(function () {
    ...
    if (f !== d) switch (f.action) {
      case "isComplete":
        return X = f.el, O(y());
      case "unmaskedvalue":
        return X !== d && f.value === d || (da = f.value, da = (a.isFunction(i.onBeforeMask) ? i.onBeforeMask.call(W, da, i) || da : da).split(""), J(d, !1, !1, Y ? da.reverse() : da), a.isFunction(i.onBeforeWrite) && i.onBeforeWrite.call(W, d, y(), 0, i)), K(X);
      case "mask":
        !function (b) {
          ba.off(b);
          var e = function (b, e) {
              ...
              if (!b.inputmask.__valueGet) {
                if (!0 !== e.noValuePatching) {
                  if (Object.getOwnPropertyDescriptor) {
                    "function" != typeof Object.getPrototypeOf && (Object.getPrototypeOf = "object" == (0, _typeof2["default"])("test".__proto__) ? function (a) {
                      return a.__proto__;
                    } : function (a) {
        ...
        break;
      case "format":
        return da = (a.isFunction(i.onBeforeMask) ? i.onBeforeMask.call(W, f.value, i) || f.value : f.value).split(""), J(d, !0, !1, Y ? da.reverse() : da), f.metadata ? {
      ...
      case "isValid":
        f.value ? (da = f.value.split(""), J(d, !0, !0, Y ? da.reverse() : da)) : f.value = y().join("");
  ...
  return e.prototype = {
    ...
    mask: function mask(i) {
      ...
      return "string" == typeof i && (i = c.getElementById(i) || c.querySelectorAll(i)), i = i.nodeName ? [i] : i, a.each(i, function (b, c) {
        ...
        i !== d && (c.inputmask !== d && (c.inputmask.opts.autoUnmask = !0, c.inputmask.remove()), c.inputmask = new e(d, d, !0), c.inputmask.opts = f, c.inputmask.noMasksCache = k.noMasksCache, c.inputmask.userOptions = a.extend(!0, {}, k.userOptions), c.inputmask.isRTL = f.isRTL || f.numericInput, c.inputmask.el = c, c.inputmask.maskset = i, a.data(c, "_inputmask_opts", f), h.call(c.inputmask, {
          action: "mask"
        }));
      }), i && i[0] ? i[0].inputmask || this : this;
    },
    option: function option(b, c) {
      return "string" == typeof b ? this.opts[b] : "object" == (0, _typeof2["default"])(b) ? (a.extend(this.userOptions, b), this.el && !0 !== c && this.mask(this.el), this) : void 0;
    },
