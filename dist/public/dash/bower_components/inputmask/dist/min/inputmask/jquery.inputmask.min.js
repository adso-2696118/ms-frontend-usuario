...
!function (a) {
  "function" == typeof define && define.amd ? define(["jquery", "./inputmask"], a) : "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) ? module.exports = a(require("jquery"), require("./inputmask")) : a(jQuery, window.Inputmask);
}(function (a, b) {
  return void 0 === a.fn.inputmask && (a.fn.inputmask = function (c, d) {
    ...
    if (void 0 === d && (d = {}), "string" == typeof c) switch (c) {
      ...
      if ("object" == (0, _typeof2["default"])(c)) return e = new b(c), void 0 === c.mask && void 0 === c.alias ? this.each(function () {
