...
(function (h) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) ? module.exports = function (E, G) {
    E || (E = window);
      ...
      b = function b(_b) {
        if (_b && _b.time) {
          ...
          if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && _b.time < +new Date() - 1E3 * g) && !(_b.columns && f.length !== _b.columns.length))) {
            ...
            if (_b.columns) {
              d = 0;
              for (e = _b.columns.length; d < e; d++) g = _b.columns[d], g.visible !== k && (f[d].bVisible = g.visible), g.search !== k && h.extend(a.aoPreSearchCols[d], Ab(g.search));
            }
