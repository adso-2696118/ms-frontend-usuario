 ...
 */
!function (t) {
  "function" == typeof define && define.amd ? define(["jquery", "moment"], t) : "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) ? module.exports = t(require("jquery"), require("moment")) : t(jQuery, moment);
}(function (t, e) {
  function n(t) {
    return j(t, Gt);
  }
  ...
  function N(t, e) {
    var n = O(t);
    return "week" === n && "object" == (0, _typeof2["default"])(e) && e.days && (n = "day"), n;
  }
  function V(t, n, i) {
  ...
  function j(t, e) {
    ...
    if (e) for (n = 0; n < e.length; n++) {
      for (i = e[n], s = [], r = t.length - 1; r >= 0; r--) if ("object" == (0, _typeof2["default"])(o = t[r][i])) s.unshift(o);else if (void 0 !== o) {
        l[i] = o;
        break;
      }
      s.length && (l[i] = j(s));
    ...
    function o(i) {
      ...
      return o && t.each(o.split(" "), function (n) {
        ...
        t.each(this.split(","), function (n, i) {
          var r, h, d, f, g, v, m, y;
          "title" == i ? (o = o.add(t("<h2>&nbsp;</h2>")), c = !1) : ((r = a[i]) ? (d = function d(t) {
            r.click && r.click.call(y[0], t);
          }, (f = s.getCustomButtonIconClass(r)) || (f = s.getIconClass(i)) || (g = r.text)) : (h = e.getViewSpec(i)) ? (p.push(i), d = function d() {
            e.changeView(i);
          }, (g = h.buttonTextOverride) || (f = s.getIconClass(i)) || (g = h.buttonTextDefault)) : e[i] && (d = function d() {
            e[i]();
  ...
  var ee = Vt.EmitterMixin = {
      ...
      hasHandlers: function hasHandlers(e) {
    ...
    ne = Vt.ListenerMixin = function () {
      ...
      return {
        ...
        listenTo: function listenTo(e, n, i) {
          if ("object" == (0, _typeof2["default"])(n)) for (var s in n) n.hasOwnProperty(s) && this.listenTo(e, s, n[s]);else "string" == typeof n && e.on(n + "." + this.getListenerNamespace(), t.proxy(i, this));
        },
    ...
    ie = {
      standardPropMap: {},
      applyRawProps: function applyRawProps(t) {
        var e,
      ...
      applyManualRawProps: function applyManualRawProps(t) {
        return !0;
      },
      applyOtherRawProps: function applyOtherRawProps(t) {}
    },
    se = function se(t) {
    ...
    oe = ht.extend(ee, ne, {
      ...
      setProps: function setProps(t) {
        var e,
          ...
          i = {},
          s = 0;
        for (e in t) "object" != (0, _typeof2["default"])(n = t[e]) && n === this._props[e] || (i[e] = n, s++);
        if (s) {
  ...
  var pe = ht.extend(ne, {
    ...
    ve = oe.extend({
      ...
      renderEventsPayload: function renderEventsPayload(t) {
      ...
      renderSelectionFootprint: function renderSelectionFootprint(t) {
      ...
      isEventDefDraggable: function isEventDefDraggable(t) {
        return this.isEventDefStartEditable(t);
      },
      isEventDefStartEditable: function isEventDefStartEditable(t) {
        var e = t.isStartExplicitlyEditable();
        return null == e && null == (e = this.opt("eventStartEditable")) && (e = this.isEventDefGenerallyEditable(t)), e;
      },
      isEventDefGenerallyEditable: function isEventDefGenerallyEditable(t) {
        var e = t.isExplicitlyEditable();
        return null == e && (e = this.opt("editable")), e;
      },
      isEventDefResizableFromStart: function isEventDefResizableFromStart(t) {
        return this.opt("eventResizableFromStart") && this.isEventDefResizable(t);
      },
      isEventDefResizableFromEnd: function isEventDefResizableFromEnd(t) {
        return this.isEventDefResizable(t);
      },
      isEventDefResizable: function isEventDefResizable(t) {
      ...
      filterEventRenderEl: function filterEventRenderEl(e, n) {
      ...
      formatRange: function formatRange(t, e, n, i) {
        var s = t.end;
      ...
      isMultiDayRange: function isMultiDayRange(t) {
        var e = this.computeDayRange(t);
        return e.end.diff(e.start, "days") > 1;
      },
      callChildren: function callChildren(t) {
        var e,
          n,
    ...
    me = Vt.Grid = ve.extend({
      ...
      eventRangesToEventFootprints: function eventRangesToEventFootprints(t) {
        var e,
          n = [];
        for (e = 0; e < t.length; e++) n.push.apply(n, this.eventRangeToEventFootprints(t[e]));
        return n;
      },
      eventRangeToEventFootprints: function eventRangeToEventFootprints(t) {
        return [new Ue(new xe(t.unzonedRange, t.eventDef.isAllDay()), t.eventDef, t.eventInstance)];
      },
      eventFootprintsToSegs: function eventFootprintsToSegs(t) {
        var e,
          n = [];
        for (e = 0; e < t.length; e++) n.push.apply(n, this.eventFootprintToSegs(t[e]));
        return n;
      },
      eventFootprintToSegs: function eventFootprintToSegs(t, e) {
        var n,
          i,
          s,
      ...
      componentFootprintToSegs: function componentFootprintToSegs(t) {}
    });
  me.mixin({
    ...
    buildDaySelectListener: function buildDaySelectListener() {
      ...
      return new fe(this, {
        ...
        hitOver: function hitOver(n, i, s) {
          var o, a;
    ...
    computeSelectionFootprint: function computeSelectionFootprint(t, e) {
    ...
    isSelectionFootprintAllowed: function isSelectionFootprintAllowed(t) {
    ...
    buildBusinessHourSegs: function buildBusinessHourSegs(t) {
      return this.eventFootprintsToSegs(this.buildBusinessHourEventFootprints(t));
    },
    buildBusinessHourEventFootprints: function buildBusinessHourEventFootprints(t) {
      var e = this.view.calendar;
      return this._buildBusinessHourEventFootprints(t, e.opt("businessHours"));
    },
    _buildBusinessHourEventFootprints: function _buildBusinessHourEventFootprints(t, e) {
      var n,
        i,
    ...
    _getEventTimeText: function _getEventTimeText(t, e, n, i, s) {
    ...
    isEventInstanceGroupAllowed: function isEventInstanceGroupAllowed(t) {
      var e,
    ...
    renderHelperEventFootprints: function renderHelperEventFootprints(t, e) {
      return this.renderHelperEventFootprintEls(t, e).addClass("fc-helper");
    },
    renderHelperEventFootprintEls: function renderHelperEventFootprintEls(t, e) {},
    unrenderHelper: function unrenderHelper() {},
    fabricateEventFootprint: function fabricateEventFootprint(t) {
      var e,
    ...
    buildSegDragListener: function buildSegDragListener(t) {
      ...
      var f = this.segDragListener = new fe(a, {
        ...
        hitOver: function hitOver(e, o, c) {
          var d,
            g,
            p,
            v,
    ...
    computeEventDropMutation: function computeEventDropMutation(t, e, n) {
      var i,
        s,
        r,
    ...
    buildSegResizeListener: function buildSegResizeListener(t, e) {
      ...
      return this.segResizeListener = new fe(this, {
        ...
        hitOver: function hitOver(n, o, c) {
          var d,
            f = !0,
    ...
    computeEventStartResizeMutation: function computeEventStartResizeMutation(t, e, n) {
      var i,
        s,
    ...
    computeEventEndResizeMutation: function computeEventEndResizeMutation(t, e, n) {
      var i,
        s,
        r = n.componentFootprint.unzonedRange,
    ...
    computeExternalDrop: function computeExternalDrop(e, n) {
      var i,
        s = this.view.calendar,
    ...
    isExternalInstanceGroupAllowed: function isExternalInstanceGroupAllowed(t) {
      var e,
        n = this.view.calendar,
  ...
  var ye = Vt.DayTableMixin = {
    ...
    we = Vt.DayGrid = me.extend(ye, {
      ...
      renderHelperEventFootprintEls: function renderHelperEventFootprintEls(e, n) {
        var i,
          s = [],
  ...
  we.mixin({
    ...
    resliceDaySegs: function resliceDaySegs(t, e) {
      var n,
        i = e.clone(),
  ...
  var De = Vt.TimeGrid = me.extend(ye, {
    ...
    renderNowIndicator: function renderNowIndicator(e) {
      var n,
        i = this.componentFootprintToSegs(new xe(new Me(e, e.valueOf() + 1), !1)),
  ...
  var be = Vt.View = ve.extend({
    ...
    triggerEventDrop: function triggerEventDrop(t, e, n, i, s) {
      this.publiclyTrigger("eventDrop", {
        context: i[0],
        args: [t.toLegacy(), e, n, s, {}, this]
      });
    },
    reportExternalDrop: function reportExternalDrop(t, e, n, i, s, r) {
      e && this.calendar.eventManager.addEventDef(t, n), this.triggerExternalDrop(t, e, i, s, r);
    },
    triggerExternalDrop: function triggerExternalDrop(t, e, n, i, s) {
    ...
    reportEventResize: function reportEventResize(t, e, n, i) {
    ...
    triggerEventResize: function triggerEventResize(t, e, n, i, s) {
    ...
    renderSelectionFootprint: function renderSelectionFootprint(t, e) {
    ...
    selectEventInstance: function selectEventInstance(t) {
    ...
    isEventDefSelected: function isEventDefSelected(t) {
  ...
  be.watch("displayingDates", ["dateProfile"], function (t) {
    ...
    buildRangeFromDuration: function buildRangeFromDuration(t, n, i, s) {
      var r,
        o,
        a,
    ...
    isDateInOtherMonth: function isDateInOtherMonth(t) {
      return !1;
    },
    getUnzonedRangeOption: function getUnzonedRangeOption(t) {
      var e = this.opt(t);
  ...
  var Ee = Vt.Calendar = ht.extend(ee, {
    ...
    publiclyTrigger: function publiclyTrigger(e, n) {
      var i,
        s,
        r = this.opt(e);
    ...
    hasPublicHandlers: function hasPublicHandlers(t) {
    ...
    reportViewDatesChanged: function reportViewDatesChanged(t, e) {
    ...
    buildSelectFootprint: function buildSelectFootprint(t, e) {
      var n,
    ...
    parseUnzonedRange: function parseUnzonedRange(t) {
      var e = null,
        n = null;
    ...
    requestEvents: function requestEvents(t, e) {
  ...
  Ee.mixin({
    ...
    option: function option(t, e) {
      ...
      } else "object" == (0, _typeof2["default"])(t) && this.setOptions(t);
    },
    opt: function opt(t) {
    ...
    footprintToDateProfile: function footprintToDateProfile(t, e) {
      var n,
  ...
  Ee.prototype.buildCurrentBusinessFootprints = function (t) {
    ...
    var n;
    return "businessHours" === t ? this.buildCurrentBusinessFootprints(e) : "object" == (0, _typeof2["default"])(t) ? (n = this.parseEventDefToInstances(t), n ? this.eventInstancesToFootprints(n) : this.parseFootprints(t)) : null != t ? (n = this.eventManager.getEventInstancesWithId(t), this.eventInstancesToFootprints(n)) : void 0;
    ...
    getEventSourceById: function getEventSourceById(t) {
      return this.eventManager.getSourceById(_e.normalizeId(t));
    },
    addEventSource: function addEventSource(t) {
      var e = qe.parse(t, this);
      e && this.eventManager.addSource(e);
    },
    removeEventSources: function removeEventSources(t) {
      var e,
        n,
        i = this.eventManager;
    ...
    removeEventSource: function removeEventSource(t) {
      var e,
        n = this.eventManager,
        i = n.querySources(t);
    ...
    refetchEventSources: function refetchEventSources(t) {
      var e,
        n = this.eventManager,
    ...
    renderEvents: function renderEvents(t, e) {
      this.eventManager.freeze();
      for (var n = 0; n < t.length; n++) this.renderEvent(t[n], e);
      this.eventManager.thaw();
    },
    renderEvent: function renderEvent(t, e) {
    ...
    clientEvents: function clientEvents(t) {
      return xt(this.eventManager.getEventInstances().map(function (t) {
        return t.toLegacy();
      }), t);
    },
    updateEvents: function updateEvents(t) {
      this.eventManager.freeze();
      for (var e = 0; e < t.length; e++) this.updateEvent(t[e]);
      this.eventManager.thaw();
    },
    updateEvent: function updateEvent(t) {
      var e,
        n,
  ...
  var Me = Vt.UnzonedRange = ht.extend({
    ...
    ze = ht.extend(ee, ne, {
      ...
      requestEvents: function requestEvents(t, e, n, i) {
      ...
      refetchSource: function refetchSource(t) {
      ...
      multiQuerySources: function multiQuerySources(e) {
        e ? t.isArray(e) || (e = [e]) : e = [];
        var n,
          i = [];
      ...
      querySources: function querySources(e) {
        var n,
          i,
          s = this.otherSources;
      ...
      getSourceById: function getSourceById(e) {
        return t.grep(this.otherSources, function (t) {
          return t.id && t.id === e;
        })[0];
      },
      setPeriod: function setPeriod(t) {
      ...
      mutateEventsWithId: function mutateEventsWithId(t, e) {
        var n,
      ...
      buildMutatedEventInstanceGroup: function buildMutatedEventInstanceGroup(t, e) {
        var n,
          i,
  ...
  var Fe = ht.extend(ee, {
      ...
      constructor: function constructor(t, e, n) {
      ...
      isWithinRange: function isWithinRange(t, e) {
        return !t.isBefore(this.start) && !e.isAfter(this.end);
      },
      requestSources: function requestSources(t) {
        this.freeze();
        for (var e = 0; e < t.length; e++) this.requestSource(t[e]);
        this.thaw();
      },
      requestSource: function requestSource(t) {
        var e = this,
          n = {
            source: t,
            status: "pending"
      ...
      purgeSource: function purgeSource(t) {
      ...
      getEventDefsById: function getEventDefsById(t) {
        var e = this.eventDefsById[t];
        return e ? e.slice() : [];
      },
      addEventDefs: function addEventDefs(t) {
        for (var e = 0; e < t.length; e++) this.addEventDef(t[e]);
      },
      addEventDef: function addEventDef(t) {
        var e,
      ...
      removeEventDef: function removeEventDef(t) {
      ...
      getEventInstancesWithId: function getEventInstancesWithId(t) {
        var e = this.eventInstanceGroupsById[t];
        return e ? e.eventInstances.slice() : [];
      },
      getEventInstancesWithoutId: function getEventInstancesWithoutId(t) {
        var e,
      ...
      addEventInstance: function addEventInstance(t, e) {
        var n = this.eventInstanceGroupsById;
        (n[e] || (n[e] = new Oe())).eventInstances.push(t), this.tryRelease();
      },
      removeEventInstancesForDef: function removeEventInstancesForDef(t) {
        var e,
          n = this.eventInstanceGroupsById,
          i = n[t.id];
    ...
    Be = Vt.EventDef = ht.extend(ie, {
      ...
      buildInstances: function buildInstances(t) {},
      clone: function clone() {
      ...
      applyManualRawProps: function applyManualRawProps(e) {
  ...
  var Le = ht.extend({
    ...
    Oe = ht.extend({
      ...
      sliceRenderRanges: function sliceRenderRanges(t) {
        return this.isInverse() ? this.sliceInverseRenderRanges(t) : this.sliceNormalRenderRanges(t);
      },
      sliceNormalRenderRanges: function sliceNormalRenderRanges(t) {
        var e,
          n,
          i,
      ...
      sliceInverseRenderRanges: function sliceInverseRenderRanges(t) {
  ...
  var Ve = ht.extend({
    ...
    Ge = Vt.EventDefMutation = ht.extend({
      dateMutation: null,
      rawProps: null,
      mutateSingle: function mutateSingle(t) {
        var e;
      ...
      setDateMutation: function setDateMutation(t) {
  ...
  Ge.createFromRawProps = function (t, e, n) {
    var i,
      ...
      a = t.def,
      l = {};
    for (i in e) "object" != (0, _typeof2["default"])(e[i]) && "start" !== i && "end" !== i && "allDay" !== i && "source" !== i && "_id" !== i && (l[i] = e[i]);
  ...
  var We = ht.extend({
    ...
    startDelta: null,
    endDelta: null,
    buildNewDateProfile: function buildNewDateProfile(t, e) {
      var n = t.start.clone(),
        i = null,
        s = !1;
    ...
    setDateDelta: function setDateDelta(t) {
      t && t.valueOf() ? this.dateDelta = t : this.dateDelta = null;
    },
    setStartDelta: function setStartDelta(t) {
      t && t.valueOf() ? this.startDelta = t : this.startDelta = null;
    },
    setEndDelta: function setEndDelta(t) {
  ...
  var _e = ht.extend(ie, {
    ...
    fetch: function fetch(t, e, n) {},
    removeEventDefsById: function removeEventDefsById(t) {},
    removeAllEventDefs: function removeAllEventDefs() {},
    getPrimitive: function getPrimitive(t) {},
    parseEventDefs: function parseEventDefs(t) {
      var e,
        n,
        i = [];
  ...
  _e.allowRawProps = se, _e.uuid = 0, _e.normalizeId = function (t) {
    ...
    var n = new this(e);
    return !("object" != (0, _typeof2["default"])(t) || !n.applyRawProps(t)) && n;
  }, Vt.EventSource = _e;
  var qe = {
    sourceClasses: [],
  ...
  var Ye = _e.extend({
    ...
    setRawEventDefs: function setRawEventDefs(t) {
  ...
  var Ze = _e.extend({
    ...
    buildRequestParams: function buildRequestParams(e, n, i) {
      var s,
        r,
        o,
        a,
  ...
  var Qe = Vt.ThemeRegistry = {
      ...
      getThemeClass: function getThemeClass(t) {
    ...
    $e = Vt.Theme = ht.extend({
      ...
      setIconOverride: function setIconOverride(e) {
        var n, i;
      ...
      applyIconOverridePrefix: function applyIconOverridePrefix(t) {
      ...
      getIconClass: function getIconClass(t) {
        var e = this.iconClasses[t];
        return e ? this.baseIconClass + " " + e : "";
      },
      getCustomButtonIconClass: function getCustomButtonIconClass(t) {
        var e;
