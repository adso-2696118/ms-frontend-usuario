...
(function (factory) {
  ...
  var GcalEventSource = EventSource.extend({
        ...
        JsonFeedEventSource.AJAX_DEFAULTS, ajaxSettings, {
          ...
          success: function success(responseData) {
            ...
            if (responseData.error) {
              ...
              successRes = applyAll(onSuccess, this,
              // forward `this`
    ...
    gcalItemsToRawEventDefs: function gcalItemsToRawEventDefs(items, gcalTimezone) {
      var _this = this;
      return items.map(function (item) {
        return _this.gcalItemToRawEventDef(item, gcalTimezone);
      });
    },
    gcalItemToRawEventDef: function gcalItemToRawEventDef(item, gcalTimezone) {
    ...
    reportError: function reportError(message, apiErrorObjs) {
