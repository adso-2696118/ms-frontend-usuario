...
+function (a) {
  ...
  function b(b) {
    return this.each(function () {
      var e = a(this),
        g = e.data(c);
      if (!g) {
        var h = a.extend({}, d, e.data(), "object" == (0, _typeof2["default"])(b) && b);
  ...
  function b(b) {
    return this.each(function () {
      var e = a(this),
        f = e.data(c);
      if (!f) {
        var g = a.extend({}, d, e.data(), "object" == (0, _typeof2["default"])(b) && b);
  ...
  function b(b) {
    return this.each(function () {
      var e = a(this);
      if (!e.data(c)) {
        var f = a.extend({}, d, e.data(), "object" == (0, _typeof2["default"])(b) && b);
        e.data(c, new h(e, f));
      }
    });
  }
