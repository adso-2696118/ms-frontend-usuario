...
(function (e) {
  ...
  e.extend(n.prototype, {
    ...
    _selectDate: function _selectDate(t, i) {
      var s,
        n = e(t),
        a = this._getInst(n[0]);
      i = null != i ? i : this._formatDate(a), a.input && a.input.val(i), this._updateAlternate(a), s = this._get(a, "onSelect"), s ? s.apply(a.input ? a.input[0] : null, [i, a]) : a.input && a.input.trigger("change"), a.inline ? this._updateDatepicker(a) : (this._hideDatepicker(), this._lastInput = a.input[0], "object" != (0, _typeof2["default"])(a.input[0]) && a.input.focus(), this._lastInput = null);
    },
    ...
    parseDate: function parseDate(t, i, s) {
      ...
      if (i = "object" == (0, _typeof2["default"])(i) ? "" + i : i + "", "" === i) return null;
      var n,
        a,
        o,
        r,
    ...
    _formatDate: function _formatDate(e, t, i, s) {
      ...
      var n = t ? "object" == (0, _typeof2["default"])(t) ? t : this._daylightSavingAdjust(new Date(s, i, t)) : this._daylightSavingAdjust(new Date(e.currentYear, e.currentMonth, e.currentDay));
  ...
  e.effects = {
    ...
    function i(t) {
      return !t || "number" == typeof t || e.fx.speeds[t] ? !0 : "string" != typeof t || e.effects.effect[t] ? e.isFunction(t) ? !0 : "object" != (0, _typeof2["default"])(t) || t.effect ? !1 : !0 : !0;
    }
    e.extend(e.effects, {
      version: "1.11.4",
