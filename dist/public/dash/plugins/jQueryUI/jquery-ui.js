  ...
  $.extend(Datepicker.prototype, {
    ...
    _selectDate: function _selectDate(id, dateStr) {
      ...
      if (inst.inline) {
        ...
        if ((0, _typeof2["default"])(inst.input[0]) !== "object") {
    ...
    parseDate: function parseDate(format, value, settings) {
      ...
      value = (0, _typeof2["default"])(value) === "object" ? value.toString() : value + "";
      if (value === "") {
        return null;
      }
      var iFormat,
    ...
    _formatDate: function _formatDate(inst, day, month, year) {
      ...
      var date = day ? (0, _typeof2["default"])(day) === "object" ? day : this._daylightSavingAdjust(new Date(year, month, day)) : this._daylightSavingAdjust(new Date(inst.currentYear, inst.currentMonth, inst.currentDay));
  ...
  */
  ...
  (function () {
    ...
    function standardAnimationOption(option) {
      ...
      if ((0, _typeof2["default"])(option) === "object" && !option.effect) {
        return true;
      }
