...
(function (e, t, n, r) {
  ...
  i.prototype = {
    ...
    decrementMinute: function decrementMinute(e) {
      var t;
      if (e) {
        t = this.minute - e;
      } else {
    ...
    formatTime: function formatTime(e, t, n, r) {
      e = e < 10 ? "0" + e : e;
      t = t < 10 ? "0" + t : t;
      n = n < 10 ? "0" + n : n;
    ...
    incrementMinute: function incrementMinute(e) {
      var t;
      if (e) {
        t = this.minute + e;
      } else {
    ...
    setDefaultTime: function setDefaultTime(e) {
      if (!this.$element.val()) {
        if (e === "current") {
          var t = new Date(),
            n = t.getHours(),
  ...
  e.fn.timepicker = function (t) {
    ...
    return this.each(function () {
      var r = e(this),
        s = r.data("timepicker"),
        o = (0, _typeof2["default"])(t) === "object" && t;
      if (!s) {
