  ...
  if ($.fn.inputmask === undefined) {
    ...
    var maskScope = function maskScope(masksets, activeMasksetIndex, opts, actionObj) {
      ...
      function isValid(pos, c, strict) {
        ...
        function _isValid(position, activeMaskset, c, strict) {
          ...
          return activeMaskset['tests'][testPos].fn != null ? activeMaskset['tests'][testPos].fn.test(chrs, buffer, position, strict, opts) : c == getBufferElement(activeMaskset['_buffer'], position, true) || c == opts.skipOptionalPartCharacter ? {
            "refresh": true,
      ...
      function checkVal(input, writeOut, strict, nptvl, intelliCheck) {
        ...
        $.each(masksets, function (ndx, ms) {
          if ((0, _typeof2["default"])(ms) == "object") {
          ...
          if (k) {
            ...
            if (isSlctn) {
              ...
              $.each(masksets, function (ndx, lmnt) {
                ...
                if ((0, _typeof2["default"])(lmnt) == "object") {
                  activeMasksetIndex = ndx;
    ...
    $.inputmask = {
      ...
      defaults: {
        ...
        onKeyUp: $.noop,
        //override to implement autocomplete on certain keys for example
        onKeyDown: $.noop,
        //override to implement autocomplete on certain keys for example
        onBeforePaste: undefined,
        //executes before masking the pasted value to allow preprocessing of the pasted value.  args => pastedValue => return processedValue
        onUnMask: undefined,
        //executes after unmasking to allow postprocessing of the unmaskedvalue.  args => maskedValue, unmaskedValue
        ...
        isNumeric: false,
        //enable numeric features
        radixPoint: "",
        //".", // | ","
        skipRadixDance: false,
        //disable radixpoint caret positioning
    ...
    $.fn.inputmask = function (fn, options) {
      ...
      } else if ((0, _typeof2["default"])(fn) == "object") {
